  ...
  <div class="max-w-6xl mx-auto">
    <header class="text-center mb-8 md:mb-12">
      ...
      <p class="text-base md:text-lg max-w-2xl mx-auto text-[#6b7a8c]">
        The building blocks of all musical sound. Toggle harmonics to shape the
        timbre.
      </p>
    </header>

    <div
      class="bg-gradient-to-br from-[#0c1018] to-[#121820] border border-[#1e2836] rounded-2xl p-4 md:p-6 mb-6"
    >
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
          ...
          <div
            class="w-3 h-3 rounded-full transition-colors duration-300"
            class:animate-pulse={isPlaying}
            style:background-color={isPlaying ? "#00e8b8" : "#1e2836"}
          ></div>
        </div>
      </div>
      <canvas
          ...
          >
            <div class="flex items-center justify-between mb-2">
              <span
                ...
                style:color={h.active ? "#00e8b8" : "#6b7a8c"}>#{h.number}</span
              >
    ...
    <div class="mt-8 text-center text-[#6b7a8c] text-sm">
      <p>
        The harmonic series consists of frequencies at integer multiples of a
        fundamental. Each combination creates a unique timbre.
      </p>
    </div>
  </div>
</div>
