...
<div class="harmonics-app p-4 md:p-8 bg-[#06080c] text-[#e8ecf4] font-sans">
    <div class="max-w-6xl mx-auto">
        <header class="text-center mb-8 md:mb-12">
            <h1 class="font-mono text-3xl md:text-5xl font-bold tracking-tight mb-3">
        ...
        <div class="info-card rounded-2xl p-4 md:p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    <div 
                        ...
                        style:background-color={isPlaying ? '#00e8b8' : '#6b7a8c'}>
                    </div>
                    <span class="font-mono text-sm text-[#6b7a8c]">WAVEFORM</span>
                </div>
            ...
            <canvas 
                ...
                style="background: #06080c; height: 180px;">
            </canvas>
        </div>

        <div class="grid md:grid-cols-3 gap-4 md:gap-6 mb-6">
            <div class="info-card rounded-2xl p-4 md:p-6">
                <h3 class="font-mono text-xs tracking-wider mb-4 text-[#6b7a8c]">MASTER CONTROLS</h3>

                <div class="mb-5">
                    <label class="flex items-center justify-between mb-2">
                        <span class="text-sm">Fundamental</span>
                        <span class="font-mono text-sm text-[#00e8b8]">{fundamentalFreq} Hz</span>
                    </label>
                    <input type="range" min="55" max="440" value={fundamentalFreq} oninput={handleFreqChange} class="volume-slider" aria-label="Fundamental frequency">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="range" min="0" max="100" value={masterVolume} oninput={handleMasterVolChange} class="volume-slider" aria-label="Master volume">
                </div>
                ...
                <button 
                    ...
                    style:background={isPlaying ? 'linear-gradient(135deg, #ff7844 0%, #cc5020 100%)' : '#121820'}
            ...
            <div class="md:col-span-2 info-card rounded-2xl p-4 md:p-6">
                <h3 class="font-mono text-xs tracking-wider mb-4 text-[#6b7a8c]">HARMONICS (1-16)</h3>
                <div class="grid grid-cols-4 md:grid-cols-8 gap-2 md:gap-3">
                    {#each harmonics as h, i}
                        <button 
                            ...
                            style:border-color={h.active ? 'transparent' : '#1e2836'}
        ...
        <div class="info-card rounded-2xl p-4 md:p-6">
            <h3 class="font-mono text-xs tracking-wider mb-4 text-[#6b7a8c]">HARMONIC DETAILS</h3>
                ...
                {#each harmonics as h, i}
                    <div class="p-3 rounded-xl transition-all duration-200"
                        ...
                        <div class="flex items-center justify-between mb-2">
                             <span class="font-mono font-bold text-lg" style:color={h.active ? '#00e8b8' : '#6b7a8c'}>#{h.number}</span>
                             <span class="text-xs text-[#6b7a8c]">{INTERVAL_NAMES[i]}</span>
                        </div>
        ...
        <div class="mt-8 text-center text-[#6b7a8c] text-sm">
             <p>
                 The harmonic series consists of frequencies at integer multiples of a fundamental.
                 Each combination creates a unique timbre.
             </p>
        </div>
    </div>
</div>
...
<style>
    ...
    .harmonic-btn.active {
        background: linear-gradient(135deg, #00e8b8 0%, #00a080 100%) !important;
        color: #06080c;
        box-shadow: 0 0 24px rgba(0, 232, 184, 0.15), 0 0 48px rgba(0, 232, 184, 0.15);
    }
