...
export const foundation: PhaseData = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        {
          guideline: "Check mono at the end of every production session",
          detail:
            "Catches phase issues early, before they compound. Use a Mono utility on the master bus momentarily.",
        },
        {
          guideline: "Bass and kick must survive mono intact",
          detail:
...
export const structureElements: StructureElement[] = [
  {
    ...
    guidelines: [
      ...
      {
        guideline: "Use VCA/group faders for section moves",
        detail:
          "Automation of individual faders is fragile. Group-level moves preserve internal balance while shaping the mix.",
      },
      {
        guideline: "Unmask buried elements by pulling competitors down",
        detail:
  ...
  },
  {
    ...
    guidelines: [
      ...
      {
        guideline: "Avoid reverb on low-frequency elements",
        detail:
          "Reverb on bass-heavy sources muddies the low-mid. High-pass the reverb return at 200–300 Hz.",
      },
      {
        guideline: "Automate reverb sends for movement",
        detail:
  ...
  },
  {
    ...
    guidelines: [
      {
        guideline:
          "Shave peaks at track and subgroup level before they reach the master bus",
        detail:
      ...
      {
        guideline:
          "Sync compressor release time to a musical tempo subdivision",
        detail:
  ...
  sections: [
    {
      ...
      items: [
        {
          guideline: "Automate volume before anything else",
          detail:
        ...
        {
          guideline: "Breakdowns should feel like release",
          detail:
            "Strip out elements and let the reverb tail carry the energy out. The breakdown earns the return.",
        },
        {
          guideline: "Automate after all static decisions are locked",
          detail:
    ...
    },
    {
      ...
      items: [
        ...
        {
          guideline:
            "For ambient music, −18 to −16 LUFS integrated is a valid target",
          detail:
