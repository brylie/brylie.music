...
**Structure** covers six elements ordered by impact — Balance, Frequency, Panorama, Dimension, Dynamics, and Interest. The ordering reflects consequence, not chronology. Balance has the most downstream effect on every other decision; Interest is the most subtle. Return to any element whenever a new sound enters the arrangement or an existing one changes significantly.
